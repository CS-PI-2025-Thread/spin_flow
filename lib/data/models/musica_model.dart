  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        AppRoutes.musicCategoryForm: (context) =>
            const FormStudent(), // Placeholder for music category form
        AppRoutes.artistBandForm: (context) =>
            const FormStudent(), // Placeholder for artist/band form
        AppRoutes.teamForm: (context) =>
            const FormStudent(), // Placeholder for team form
        AppRoutes.bikeForm: (context) =>
            const FormStudent(), // Placeholder for bike form
        AppRoutes.musicForm: (context) =>
            const FormStudent(), // Placeholder for music form
        AppRoutes.mixClassForm: (context) =>
            const FormStudent(), // Placeholder for mix class form
        AppRoutes.groupStudentForm: (context) =>
            const FormStudent(), // Placeholder for group student form
      },
    );
  }
}
